...
// Get input values and add to tableData array
function addData() {
...
// Function to edit row in tableData array
function editData(index) {
  ...
  function renData() {
    ...
    let firstname = renData.map(({ firstName }) => firstName);
    console.log(firstname);

    let lastname = renData.map(({ lastName }) => lastName);
